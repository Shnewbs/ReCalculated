...
public class SlotHelper {
    ...
    public static boolean checkInsert(int slot, @Nonnull ItemStack stack, @Nullable Direction face, EnumFilterType internal, ISonarInventory inv, boolean def) {
    ...
    public static boolean checkExtract(int slot, int count, @Nullable Direction face, EnumFilterType internal, ISonarInventory inv, boolean def) {
        boolean validFilters = false;
        boolean extract = def;
