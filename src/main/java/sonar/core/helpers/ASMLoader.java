...
public class ASMLoader {
	...
	public static final Comparator<ASMData> SORT_PRIORITY = (str1, str2) ->
			SonarHelper.compareWithDirection((int) str1.getAnnotationInfo().get("priority"),
					(int) str2.getAnnotationInfo().get("priority"),
					SortingDirection.UP);
	...
	public static List<ITileEnergyHandler> getTileEnergyHandlers(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, TileEnergyHandler.class, ITileEnergyHandler.class, true, true);
	}

	public static List<ISonarFluidHandler> getFluidHandlers(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, FluidHandler.class, ISonarFluidHandler.class, true, true);
	}

	public static List<IItemEnergyHandler> getItemEnergyHandlers(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, ItemEnergyHandler.class, IItemEnergyHandler.class, true, true);
	}

	public static List<ISonarPlanter> getPlanters(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, ASMPlanter.class, ISonarPlanter.class, true, true);
	}

	public static List<ISonarHarvester> getHarvesters(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, ASMHarvester.class, ISonarHarvester.class, true, true);
	}

	public static List<ISonarFertiliser> getFertilisers(Logger logger, @Nonnull ASMDataTable asmDataTable) {
		return getInstances(logger, asmDataTable, ASMFertiliser.class, ISonarFertiliser.class, true, true);
	}
